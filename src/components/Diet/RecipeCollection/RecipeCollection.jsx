...
useEffect(() => {
  ...
  const fetchRecipes = async () => {
    try {
      ...
      const recipesResponse = await axios.get(`${BASE_URL}recetas/user`, {
        headers: {
  ...
  const fetchDietCount = async () => {
    try {
      ...
      const dietCountResponse = await axios.get(`${BASE_URL}recetas/collection/count`, {
        headers: {
          Authorization: `Bearer ${authToken}`,
        },
      });
